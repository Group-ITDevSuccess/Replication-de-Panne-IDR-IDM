    ...
    return (() => {
            ...
            662: function (t, e) {
                ...
                e.default = function (t) {
                    t.API.autoTable = function () {
                        ...
                        var o = l.parseInput(this, t), r = s.createTable(this, o);
                        ...
                        var n = new i.DocHandler(this), r = o.parseHtml(n, t, window, e, !1), l = r.head, a = r.body;
                        return {
                ...
                Object.defineProperty(e, "__esModule", {value: !0}), e.parseSpacing = e.getFillStyle = e.addTableBorder = e.getStringWidth = void 0, e.getStringWidth = function (t, e, n) {
                ...
                e.parseCss = function (t, e, n, i, l) {
                    ...
                    var c = function (t, e) {
                        var n = [t.paddingTop, t.paddingRight, t.paddingBottom, t.paddingLeft], r = 96 / (72 / e),
                            i = (parseInt(t.lineHeight) - parseInt(t.fontSize)) / e / 2, l = n.map((function (t) {
                ...
                e.parseInput = function (t, e) {
                    ...
                    var f = function (t, e, n) {
                        ...
                        var n, o, r, l, a, s, u, d, h, c, f, p, g, y = i.parseSpacing(e.margin, 40 / t.scaleFactor()),
                        ...
                        var m = null !== (l = e.useCss) && void 0 !== l && l, b = e.theme || (m ? "plain" : "striped"),
                ...
                Object.defineProperty(e, "__esModule", {value: !0}), e.default = function (t, e, o, r) {
                ...
                function s(t, e, n, o, i, l) {
                    ...
                    return e.map((function (e, s) {
                        for (var u = 0, h = {}, c = 0, f = 0, p = 0, g = n; p < g.length; p++) {
                            ...
                            } else f--, c++; else a[y.index].left--, f = a[y.index].times, u++
                        }
                ...
                function d(t, e, n, o, r, i, s) {
                    ...
                    var h = a.assign({}, d.table, d[t], r.styles, u),
                        c = r.columnStyles[e.dataKey] || r.columnStyles[e.index] || {}, f = "body" === t ? c : {},
                        p = "body" === t && n % 2 == 0 ? a.assign({}, d.alternateRow, r.alternateRowStyles) : {},
                        g = l.defaultStyles(i), y = a.assign({}, g, h, p, f);
                    return a.assign(y, s)
                }
                ...
                function d(t, e, n) {
                    var r = t.styles.fontSize / n.scaleFactor() * o.FONT_ROW_RATIO, i = t.padding("vertical"),
                        l = Math.floor((e - i) / r);
                    return Math.max(0, l)
                }
                ...
                function c(t, e, n, o, r) {
                    ...
                    for (var i = 0, l = r; i < l.length; i++) {
                        ...
                        } else o.x += a.width; else o.x += a.width
                    }
                    o.y += n.height
                }
                ...
                e.drawTable = function (t, e) {
                    var n = e.settings, o = n.startY, i = n.margin, s = {x: i.left, y: o},
                ...
                var o = n(200), r = function (t, e) {
                    ...
                    void 0 === n && (n = {});
                    var o = r(t, e), i = e.settings.horizontalPageBreakRepeat, l = null, a = [], s = [],
                        u = e.columns.length, d = n && n.start ? n.start : 0;
                ...
                e.default = {
                    getColumnsCanFitInPage: i, calculateAllColumnsCanFitInPage: function (t, e) {
                ...
                e.calculateWidths = function (t, e) {
                    !function (t, e) {
                        var n = t.scaleFactor(), i = e.settings.horizontalPageBreak,
        ...
        return (() => {
            ...
            Object.defineProperty(t, "Cell", {
                ...
                var o = n.parseInput(t, e), r = l.createTable(t, o);
                i.drawTable(t, r)
