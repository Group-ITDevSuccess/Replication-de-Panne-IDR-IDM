    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('km_enter', models.FloatField(blank=True, null=True, verbose_name='Km/h Entrer')),
                ('km_exit', models.FloatField(blank=True, null=True, verbose_name='Kùm:h Sortie')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('breakdown', models.ManyToManyField(blank=True, to='idr_idm.breakdownidridm')),
            ],
            options={
                'abstract': False,
            },
